        ...
        if (this.searchable) {
            ...
            bar.innerHTML = `
                <div style="position:relative;flex:1;min-width:300px;">
                    <span style="position:absolute;left:14px;top:50%;transform:translateY(-50%);color:var(--text-secondary);pointer-events:none;font-size:1rem;">🔍</span>
                    <input id="tbl-search" type="text" placeholder="Filter records…" value="${this._query}"
                        style="width:100%;padding:10px 16px 10px 42px;border-radius:var(--radius-sm);
