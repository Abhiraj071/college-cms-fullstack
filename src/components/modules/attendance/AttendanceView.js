...
import { QRAttendance } from './QRAttendance.js';
...
export class AttendanceView {
    ...
    renderTab(container) {
        ...
        } else if (this.activeTab === 'qr-session') {
            this.renderQRSessionTab(container);
    ...
    renderScanAttendanceTab(container) {
        const qrComp = new QRAttendance('student');
        container.appendChild(qrComp.render());
    }
