export class ApiService {
    static BASE_URL = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' || window.location.hostname === ''
    ...
    static async bulkImportResults(examId, results) {
        return await this.request(`/exams/${examId}/results/bulk`, { method: 'POST', body: JSON.stringify({ examId, results }) });
    }
